...
class MainActivity : AppCompatActivity() {
    ...
    val CITY: String = "Tambun, Bekasi"
    val API: String = "9ebc1459b72603bc4e32a2935f0c7513"
    ...
    inner class weather() : AsyncTask<String, Void, String>() {
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                findViewById<TextView>(R.id.temperet).text = temp
                findViewById<TextView>(R.id.min_teperet).text = tempMin
                findViewById<TextView>(R.id.max_temperet).text = tempMax
